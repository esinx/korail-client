...
[![trunk](https://github.com/esinx/korail-client/actions/workflows/trunk.yaml/badge.svg)](https://github.com/esinx/korail-client/actions/workflows/trunk.yaml)
...
1. Run:
   ...
   ```
   corepack enable && \
   gh repo clone esinx/korail-client <directory> && \
   cd <directory> && \
   pnpm install && \
